...
class TestPayGrade:
    ...
    def test_add_new_pay_grade(self):
        ...
        self.driver.find_element(By.ID, "payGrade_name").send_keys("IlyaRagozin")
        ...
        self.driver.find_element(By.ID, "payGradeCurrency_minSalary").send_keys("5500")
        self.driver.find_element(By.ID, "payGradeCurrency_maxSalary").send_keys("27400")
    ...
    def test_remove_pay_grade(self):
        ...
        self.driver.find_element(By.ID, "btnLogin").click()
        self.driver.get("https://opensource-demo.orangehrmlive.com/index.php/admin/viewPayGrades")
        self.driver.find_element(By.LINK_TEXT, "IlyaRagozin").click()
